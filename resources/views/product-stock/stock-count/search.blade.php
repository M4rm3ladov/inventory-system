<form action="" method="" class="d-flex flex-column mt-3">
    ...
    <div class="d-flex flex-row ms-auto mt-2">
        <label for="date-from" class="my-auto ms-auto form-label text-nowrap">Period From:</label>
        <input id="date-from" name="datetime" type="date" class="form-control datetimepicker ms-2"
            wire:model.live.debounce.300ms="periodFrom" wire:change="filterChange">
        <label for="date-to" class="my-auto ms-2 me-2 form-label text-nowrap">Period To:</label>
        <input id="date-to" name="datetime" type="date" class="form-control datetimepicker"
            wire:model.live.debounce.300ms="periodTo" wire:change="filterChange">
    </div>
    <div class="d-flex flex-row ms-auto mt-2">
